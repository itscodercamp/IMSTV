...
const vehicleSchema = z.object({
  ...
  status: z.enum(["For Sale", "Sold", "In Refurbishment"]),
});
...
export function AddVehicleForm() {
  ...
  function onSubmit(values: z.infer<typeof vehicleSchema>) {
    console.log(values);
    // Here you would typically call an API to save the new vehicle
  }
            ...
            <FormItem>
              ...
              <Select onValueChange={field.onChange} defaultValue={field.value}>
                ...
                <SelectContent>
                  ...
                  <SelectItem value="In Refurbishment">In Refurbishment</SelectItem>
                </SelectContent>
              </Select>
              <FormMessage />
            </FormItem>
            ...
            <div className="flex items-center justify-center w-full">
                <label htmlFor="dropzone-file" className="flex flex-col items-center justify-center w-full h-32 border-2 border-dashed rounded-lg cursor-pointer bg-muted hover:bg-muted/80">
                    <div className="flex flex-col items-center justify-center pt-5 pb-6">
                        ...
                        <p className="text-xs text-muted-foreground">Multiple images can be uploaded</p>
                    </div>
